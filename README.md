...
* [influxdb-cpp-rest](https://github.com/d-led/influxdb-cpp-rest) ⭐ 51 | 🐛 4 | 🌐 C++ | 📅 2026-08-21 - A C++ InfluxDB client with a batching async interface
...
* [k6](https://github.com/loadimpact/k6) ⭐ 31,371 | 🐛 803 | 🌐 Go | 📅 2026-09-02 - A modern load testing tool, using Go and JavaScript
* [Telegraf](https://github.com/influxdata/telegraf) ⭐ 17,791 | 🐛 419 | 🌐 Go | 📅 2026-09-01 - (Official) plugin-driven server agent for reporting metrics into InfluxDB
...
* [vsphere-influxdb-go](https://github.com/Oxalide/vsphere-influxdb-go) ⭐ 210 | 🐛 21 | 🌐 Go | 📅 2020-04-01 - Collect VMware vSphere, vCenter and ESXi performance metrics and send them to InfluxDB
...
* [gopherwx](https://github.com/chrissnell/gopherwx) ⭐ 33 | 🐛 1 | 🌐 Go | 📅 2026-09-02 - a service that pulls live weather data from a Davis Instruments Vantage Pro2 station and stores it in InfluxDB
...
* [tesla-streamer](https://github.com/timdorr/tesla-trip/blob/master/lib/tesla_stream_reader.rb) ⭐ 19 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - Streams data from Tesla Model S to InfluxDB ([rake task](https://github.com/timdorr/tesla-trip/blob/master/lib/tasks/tesla.rake#L12-L16) ⭐ 19 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31)
...
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,502 | 🐛 102 | 🌐 Python | 📅 2026-08-30 - Glances an Eye on your system
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,391 | 🐛 63 | 🌐 Go | 📅 2026-09-02 - Analyzes resource usage and performance characteristics of running containers
* [gatling](https://github.com/gatling/gatling) ⭐ 6,954 | 🐛 19 | 🌐 Scala | 📅 2026-08-31 - Async Scala-Akka-Netty based Stress Tool
* [Riemann](https://github.com/riemann/riemann) ⭐ 4,268 | 🐛 29 | 🌐 Clojure | 📅 2026-04-05 - A network event stream processing system, in Clojure
...
* [Centreon](https://github.com/centreon/centreon) ⭐ 162 | 🐛 325 | 🌐 PHP | 📅 2026-09-02 - A network, system, applicative supervision and monitoring tool
...
* [ioBroker](http://www.iobroker.net/) - Homeautomation / IoT Platform uses Influxdb to store [history data](https://github.com/ioBroker/ioBroker.influxdb/blob/master/README.md) ⭐ 37 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-28
...
* [metrics](https://github.com/beberlei/metrics) ⭐ 323 | 🐛 0 | 🌐 PHP | 📅 2026-08-28 - (PHP) Simple library that abstracts different metrics collectors. "I find this necessary to have a consistent and simple metrics (functional) API that doesn't cause vendor lock-in"
...
* [logrus\_influxdb](https://github.com/Abramovic/logrus_influxdb) ⭐ 26 | 🐛 3 | 🌐 Go | 📅 2019-12-25 - InfluxDB Hook for [Logrus](https://github.com/Sirupsen/logrus) ⭐ 25,745 | 🐛 46 | 🌐 Go | 📅 2026-08-25
...
* [logstash-output-influxdb](https://github.com/logstash-plugins/logstash-output-influxdb) ⭐ 59 | 🐛 43 | 🌐 Ruby | 📅 2026-08-14 - Community-maintained [Logstash](https://www.elastic.co/products/logstash) plugin to output metrics to InfluxDB
...
* [embulk-output-influxdb](https://github.com/joker1007/embulk-output-influxdb) ⭐ 2 | 🐛 1 | 🌐 Ruby | 📅 2017-02-16 - InfluxDB output plugin for [Embulk](https://github.com/embulk/embulk) ⭐ 1,783 | 🐛 162 | 🌐 Java | 📅 2026-06-19
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,558 | 🐛 3,339 | 🌐 TypeScript | 📅 2026-09-02 - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB
* [Chronograf](https://github.com/influxdata/chronograf) ⭐ 1,567 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-02 - Official InfluxDB data visualization tool
...
* [Time Series Admin](https://github.com/timeseriesadmin/timeseriesadmin) ⭐ 141 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-30 - Administration panel and querying interface for InfluxDB databases
...
* [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,928 | 🐛 224 | 🌐 Go | 📅 2026-09-01
* [awesome-sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,345 | 🐛 271 | 📅 2024-03-26
* [awesome-bigdata](https://github.com/onurakpolat/awesome-bigdata) ⭐ 14,607 | 🐛 4 | 📅 2026-07-31
...
* [awesome-dashboard](https://github.com/obazoud/awesome-dashboard) ⭐ 1,174 | 🐛 2 | 📅 2026-08-01

### Lists of awesome lists that include awesome-influxdb

* [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,145 | 🐛 105 | 📅 2026-09-02
